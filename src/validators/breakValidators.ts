...
// Validador para crear break laboral
export const breakLaboralSchema = z.object({
  diaSemana: z.number()
...
// Validador para actualizar break laboral
export const updateBreakLaboralSchema = z.object({
  diaSemana: z.number()
    .int('El día de la semana debe ser un número entero')
    .min(1, 'El día de la semana debe ser entre 1 y 7')
    .max(7, 'El día de la semana debe ser entre 1 y 7')
